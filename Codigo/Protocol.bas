    ...
    With UserList(Userindex)
        ...
        If NumberOfCharacters > 0 Then
            ...
            For i = 1 To NumberOfCharacters
                Call .outgoingData.WriteASCIIString(.Account.Personajes(i).Name)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).body)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).Head)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).weapon)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).shield)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).helmet)
                Call .outgoingData.WriteByte(.Account.Personajes(i).Class)
                Call .outgoingData.WriteByte(.Account.Personajes(i).race)
                Call .outgoingData.WriteInteger(.Account.Personajes(i).Map)
                Call .outgoingData.WriteByte(.Account.Personajes(i).level)
                Call .outgoingData.WriteLong(.Account.Personajes(i).Gold)
                Call .outgoingData.WriteBoolean(.Account.Personajes(i).criminal)
                Call .outgoingData.WriteBoolean(.Account.Personajes(i).dead)
                Call .outgoingData.WriteBoolean(.Account.Personajes(i).gameMaster)
            Next i
